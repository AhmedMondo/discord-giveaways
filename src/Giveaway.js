...
class Giveaway extends EventEmitter {
    ...
    constructor(manager, options) {
        ...
        this.embedBanner = options.embedBanner
    ...
    get remainingTimeText() {
        ...
        const content = this.messages.drawing
            .replace('{durationgiveaway}', pattern)
    ...
    get data() {
        return {
            ...
            embedThumbnail: this.options.embedThumbnail,
            embedBanner: this.options.embedBanner,
